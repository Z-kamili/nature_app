                ...
                <div class="bg-white border-2  border-blue rounded-xl mt-16">
                   ...
                   <form action="#" method="POST" class="space-y-4 px-4 py-6">
                       ...
                       <div>
                          ...
                          <select name="category_add" id="category_add" class="w-full bg-gray-100 rounded-xl text-sm border-none px-4 py-2">
                       ...
                       <div>
                         ...
                         <textarea name="idea" id="idea" cols="30" rows="10" class="w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 text-sm px-4 py-2" placeholder="Descrive your idea"></textarea>

                       </div>
                        <div class="flex items-center justify-between space-x-3"> 
                            
                            <button type="button"
                                    class="flex items-center justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition 
                                    duration-150 ease-in px-6 py-3">
                            <svg class="text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
